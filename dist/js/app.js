    ...
    (() => {
                ...
                if (formRequiredItem.dataset.required === "email") {
                    ...
                    if (!formRequiredItem.value.trim()) {
                        ...
                        if (!phoneRegex.test(formRequiredItem.value)) {
                            formRequiredItem.dataset.error = "Пожалуйста, введите действительный номер";
                            this.addError(formRequiredItem);
                            error++;
                        } else {
        ...
        function initSliders() {
            if (document.querySelector(".hero-mainpage__slider")) {
                const heroSubslider = new core(".hero-mainpage__subslider", {
                ...
                const heroSlider = new core(".hero-mainpage__slider", {
                    ...
                    on: {
                        slideChange: function() {
                            ...
                            if (navText) navText.textContent = slideTitle;
                        }
                    }
                });
                heroSlider.on("slideChange", (function() {
                    heroSubslider.slideTo(heroSlider.realIndex + 1);
                }));
                document.addEventListener("click", (function(e) {
                    if (e.target.closest(".hero-mainpage__subslider-wrap")) {
                        heroSubslider.slideTo(heroSubslider.realIndex + 1);
                        heroSlider.slideNext(1e3);
                    }
                }));
            }
        }
        ...
        window.addEventListener("load", (function() {
            const dropdown = document.querySelector(".actions-header__dropdown");
            const onMouseoverHandler = e => {
                const target = e.target;
                if (dropdown) if (target.closest(".actions-header__item-wrap_profile .actions-header__item")) dropdown.classList.add("_active"); else if (!target.closest(".actions-header__item-wrap_profile")) dropdown.classList.remove("_active");
            };
